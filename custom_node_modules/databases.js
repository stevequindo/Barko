...
exports.getTransactions = async function(id, country) {
	/*
	This function retrieves all of the transactions for a given ID and country
	(usually given by the link)

	Params: None
	Return: Promise containing the transactions in the resolution
 	*/
	return Container.find({_id: id, departureCountry: country}, 'transactions').populate({
		path: 'transactions',
		populate: {path: 'sender_link receiver_link'}
	});
};

exports.getLatestTransactions = async function() {

	// Check for all transactions, the 
}
