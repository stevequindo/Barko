...
exports.parseJsonWorkbook = function(jsonWorkbook) {
	...
	// TODO: Adjust to using data tables
	// https://datatables.net/
	// https://www.npmjs.com/package/mongoose-datatables
	/* 
		Params:
...
getCountriesAux = function() {
	...
	nzCountry.lowName = encodeURIComponent(nzCountry.name);
	nzCountry.flagUrl = flags.findFlagUrlByCountryName(nzCountry.name);
...
sampleCompaniesAux = function() {
	...
	let sampleCompanyArr = [sampleCompany1];
