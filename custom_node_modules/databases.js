...
exports.findStatusInfo = function(trackingNum, Surname) {
	...
	return new Promise((resolve, reject) => {
		...
		Container
			.findOne({ 'containerLine' : { $elemMatch : {'trackingNo':trackingNum,'sender.lastName': {'$regex': lastName,$options:'i'}}}},
				{'containerLine' : {$elemMatch : {'trackingNo':trackingNum,'sender.lastName': {'$regex': lastName,$options:'i'}}}})
